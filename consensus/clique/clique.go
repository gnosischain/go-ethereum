...
func (c *Clique) Finalize(chain consensus.ChainHeaderReader, header *types.Header, state vm.StateDB, body *types.Body, _ []*types.Receipt, _ *vm.EVM, blockAccessIndex uint32, bal *bal.ConstructionBlockAccessList) {
