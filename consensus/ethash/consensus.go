...
func (ethash *Ethash) Finalize(chain consensus.ChainHeaderReader, header *types.Header, state vm.StateDB, body *types.Body, _ []*types.Receipt, evm *vm.EVM, blockAccessIndex uint32, bal *bal.ConstructionBlockAccessList) {
